...
function thissite_scripts() {
	...
	// wp_enqueue_style( 'thissite-style', get_stylesheet_uri() . '/css/thissite-style.css', array(), THISSITE_VERSION );
	wp_enqueue_style( 'thissite-style', get_stylesheet_uri() . '/css/thissite-blog.css', array(), THISSITE_VERSION );
