...
function thissite_scripts() {
	wp_enqueue_style( 'thissite-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'thissite-style', 'rtl', 'replace' );

	wp_enqueue_script( 'thissite-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
