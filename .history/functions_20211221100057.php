...
function thissite_scripts() {
	...
	wp_enqueue_script( 'thissite-navigation', get_template_directory_uri() . '/js/navigation.js', array(), THISSITE_VERSION, false );
	// echo get _template_directory_uri() . '/js/navigation.js';
	// exit;
