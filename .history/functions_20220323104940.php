...
function thissite_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar Postów', 'thissite' ),
			'id'            => 'sidebar-2',
			'description'   => esc_html__( 'Add widgets here.', 'thissite' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar Produktów', 'thissite' ),
			'id'            => 'sidebar-3',
			'description'   => esc_html__( 'Add widgets here.', 'thissite' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
function thissite_scripts() {
	...
	wp_enqueue_style( 'thissite-page', get_template_directory_uri() . '/css/Vesuvio-page.css', array(), Vesuvio_VERSION );

	wp_enqueue_style( 'Vesuvio-blog', get_template_directory_uri() . '/css/thissite-blog.css', array(), THISSITE_VERSION );
