...
class contact extends \WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        foreach($this->emailDetails as $key => $contactName) {
            ?>
                <li>
                    <?= $instance[$key] ?>
                </li>
    ...
    public function form($instance) {
        ...
        foreach($this->emailDetails as $key => $contactName) {
            ?>
            <label for="<?= $this->get_field_name($key) ?>"><?= $contactName ?></label>
            <input class="widefat" id="<?= $this->get_field_name($key) ?>" name="<?= $this->get_field_name($key) ?>"  type="" value="<?= esc_attr($$key) ?>">
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        foreach($this->emailDetails as $key) {
            $instance[$key] = !empty($new_instance[$key]) ? strip_tags($new_instance[$key], '<b><br><i>') : '';
        }
