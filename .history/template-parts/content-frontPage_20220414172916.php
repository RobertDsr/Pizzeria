...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content-front-page">
		<div>
			<a href=""></a>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" version="1.0"><path d="M1 31L16 1l15 30-15-10L1 31z" stroke-linejoin="round" fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-width="2" fill="#fff"/></svg>
		</div>
		<?php
		the_content();
