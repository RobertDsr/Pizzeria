...
function thissite_scripts() {
	...
	wp_enqueue_script( 'thissite-navigation', get_template_directory_uri() . 'underscorepluswoo/wp-content/themes/thissite/js/navigation.js', array(), THISSITE_VERSION, true );
